...
print('明天有个宴会，我要邀请一些人来参加\n'
      ...
      f"这些人，虽然我很想把他们都邀请来，但是我们的桌子只能坐下{People_sitting_on_the_table}个人，所以我必须随机抽几个人。\n"
      f"我把这个消息说给了{name_list[0]}，他说无论如何{name_list[-1]}必须来，否则他就要告诉我什么是{name_list.pop(0)[0]}外狂徒\n"
      f"因此，接下来我必须抽5个人，并且必须把{name_list[-1]}也加入进去")
# 技术限制，只能做个摸球并放回的故事了
...
print('经过了4个小时终于完成了随机抽取。\n'
      f"我抽出了，{attend_name}、{attend_name_1}、{attend_name_2}、{attend_name_3}、{attend_name_4}这四个人，并且加入了{name_list[-1]}。\n"
      f"我走到法外狂徒-张三面前把，结果告诉了他，他心满意足的离开了。\n"
      f"第二天，我邀请的{attend_name}、{attend_name_1}、{attend_name_2}、{attend_name_3}、{attend_name_4}这几个人都参加了这个宴席，但是法外狂徒击杀了{name_list[-1]}，增加了EXP"
      f"因此和{attend_name}、{attend_name_1}、{attend_name_2}、{attend_name_3}、{attend_name_4}这几个人一起出席了这个宴席\n"
      '法外狂徒-张三坐在最好的位置，说出了他最宏伟的计划——击杀罗翔！\n'
